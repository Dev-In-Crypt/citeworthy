 ...
 * начинается вовсе, а типовой аудит — это `DEFAULT_GENERATED_PROMPT_COUNT`
 * (24) вопроса × 3 сэмпла × 3 ассистента = 216 ответов. Значение ниже 216
 * означает, что первый же бесплатный аудит на наборе вопросов по умолчанию
 * упрётся в отказ. 250 — один такой аудит целиком и небольшой запас.
 */
export const FREE_CHECK_ALLOWANCE = 250;
