...
- `docs/startup-spec.md` — продуктовый спек (зачем и что); читать при сомнениях в продуктовых решениях. Лежит только локально: репозиторий публичный, а в спеке тарифы и план выхода на рынок.
